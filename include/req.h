...
body_t *req_form_parse(req_t *);        // parse the URL encoded form body
char   *req_form_get(body_t *, char *); // get a key/value from the body
void    req_form_free(body_t *);        // free the parsed form body
