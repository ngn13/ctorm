...
#if CTORM_DEBUG
#define debug(fmt, ...)                                                        \
  ctorm_debug("(" FG_BOLD "%s" FG_RESET ") " fmt, __func__, ##__VA_ARGS__)
#else
 ...
 * Print messages marked as "info", you can use this to print informative
 * messages
 ...
 * Print messages marked as "warn", you can use this to print warnings
 ...
 * Print messages marked as "fail", you can use this to print failures
